...
Домашние задания представляли собой работу над основным проектом, у которого поэтапно расширялся и добавлялся функционал – до его [финала](https://github.com/SergeyShmatok/-FeedPosts-.git).
