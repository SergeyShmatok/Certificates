### Проект: "Мое обучение и сертификаты"
...
Домашние задания (п.5-7) представляют собой работу над основным проектом, у которого поэтапно расширяется и добавляется функционал до его [финала](https://github.com/SergeyShmatok/-FeedPosts-.git).
